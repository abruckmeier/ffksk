...
urlpatterns = [
	...
	url(r'^menu/infos/$', views.anleitung, name = 'anleitung_page'),
	url(r'^menu/ersteSchritte/$', views.ersteSchritte, name = 'ersteschritte_page'),
	url(r'^menu/slackInfos/$', views.slackInfos, name = 'slackinfo_page'),
